...
echo "chromium-browser  --noerrdialogs --check-for-update-interval=31536000 --disable-background-networking --disable-component-update --disable-infobars --kiosk $KIOSK_URL"
